...
'        Dim insertQuery As New SqlCommand("INSERT INTO CCPP_EMPRESAS (ID_TIPO, CIF, NOMBRE_FISCAL, NOMBRE_COMERCIAL, ID_TIPO_VIA, NOMBRE_VIA, NUMERO_VIA, PISO, LETRA_PISO, LOCALIDAD, PROVINCIA, PAIS, CP, TELEFONO, EMAIL, WEB)
...
'        insertQuery.Parameters.Add("@ID_TIPO", SqlDbType.TinyInt).Value = CB_TIPO.SelectedValue
...
'        C_Empresas.Empresas_Load(sender, e)
